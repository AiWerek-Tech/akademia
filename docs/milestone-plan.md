...
|---|---|---|---|
| **M0** | Discovery and Foundation | Project Init, Base Layout, DB Config, Documentation | **IN PROGRESS** |
| **M1** | Auth, RBAC, Unit, Periode | User Access, Roles, Semesters, Unit Access Controls | *PLANNED* |

                ...
                <form action="<?= base_url('users') ?>" method="POST" autocomplete="off">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control rounded-3" id="username" name="username" required value="<?= old('username') ?>">
                        </div>
                        <div class="col-md-6">
                            <label for="email" class="form-label fw-semibold">Alamat Email <span class="text-danger">*</span></label>
                            <input type="email" class="form-control rounded-3" id="email" name="email" required value="<?= old('email') ?>">
                        </div>
                        <div class="col-md-6">
                            <label for="full_name" class="form-label fw-semibold">Nama Lengkap <span class="text-danger">*</span></label>
                            <input type="text" class="form-control rounded-3" id="full_name" name="full_name" required value="<?= old('full_name') ?>">
                        </div>
                        <div class="col-md-6">

            ...
            <div class="card-body p-4">
                <form action="<?= base_url('academic-years/' . $year['uuid']) ?>" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control rounded-3" id="name" name="name" placeholder="contoh: 2026/2027" required value="<?= old('name', $year['name']) ?>">
                    ...
                    <div class="row">
                        <div class="col-6 mb-3">
                            ...
                            <input type="date" class="form-control rounded-3" id="start_date" name="start_date" value="<?= old('start_date', $year['start_date']) ?>" required>
                        </div>
                        <div class="col-6 mb-3">
                            <label for="end_date" class="form-label fw-semibold">Tanggal Selesai <span class="text-danger">*</span></label>
                            <input type="date" class="form-control rounded-3" id="end_date" name="end_date" value="<?= old('end_date', $year['end_date']) ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select rounded-3" id="status" name="status" required>
                            <option value="DRAFT" <?= old('status', $year['status']) === 'DRAFT' ? 'selected' : '' ?>>DRAFT</option>
